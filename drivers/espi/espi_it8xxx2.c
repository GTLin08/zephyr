...
#define ESPI_IT8XXX2_GET_GCTRL_BASE \
	((struct gctrl_ite_ec_regs *)DT_REG_ADDR(DT_NODELABEL(gctrl)))
...
static void smfi_it8xxx2_init(const struct device *dev)
{
	...
	struct smfi_ite_ec_regs *const smfi_reg =
		(struct smfi_ite_ec_regs *)config->base_smfi;

#ifdef CONFIG_SOC_SERIES_IT8XXX2
	struct gctrl_ite_ec_regs *const gctrl = ESPI_IT8XXX2_GET_GCTRL_BASE;
