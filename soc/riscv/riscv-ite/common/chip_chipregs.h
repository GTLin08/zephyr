...
#define ILMCR_ILM1_ENABLE         BIT(1)
...
#define IT83XX_SMFI_SMECCS      ECREG(IT83XX_SMFI_BASE+0x20)
#define IT83XX_SMFI_MASK_HOSTWA 	BIT(5)
#define IT83XX_SMFI_HRAMWC      ECREG(IT83XX_SMFI_BASE+0x5A)
#define IT83XX_SMFI_HRAMW0BA    ECREG(IT83XX_SMFI_BASE+0x5B)
#define IT83XX_SMFI_HRAMW1BA    ECREG(IT83XX_SMFI_BASE+0x5C)
#define IT83XX_SMFI_HRAMW0AAS   ECREG(IT83XX_SMFI_BASE+0x5D)
#define IT83XX_SMFI_HRAMW1AAS   ECREG(IT83XX_SMFI_BASE+0x5E)
#define IT83XX_SMFI_HRAMW2BA    ECREG(IT83XX_SMFI_BASE+0x76)
#define IT83XX_SMFI_HRAMW3BA    ECREG(IT83XX_SMFI_BASE+0x77)
#define IT83XX_SMFI_HRAMW2AAS   ECREG(IT83XX_SMFI_BASE+0x78)
#define IT83XX_SMFI_HRAMW3AAS   ECREG(IT83XX_SMFI_BASE+0x79)
#define IT83XX_SMFI_H2RAMECSIE  ECREG(IT83XX_SMFI_BASE+0x7A)
#define IT83XX_SMFI_H2RAMECSA   ECREG(IT83XX_SMFI_BASE+0x7B)
#define IT83XX_SMFI_H2RAMHSS    ECREG(IT83XX_SMFI_BASE+0x7C)
#define IT83XX_SMFI_ECINDAR0    ECREG(IT83XX_SMFI_BASE+0x3B)
#define IT83XX_SMFI_ECINDAR1    ECREG(IT83XX_SMFI_BASE+0x3C)
#define IT83XX_SMFI_ECINDAR2    ECREG(IT83XX_SMFI_BASE+0x3D)
#define IT83XX_SMFI_ECINDAR3    ECREG(IT83XX_SMFI_BASE+0x3E)
#define EC_INDIRECT_READ_INTERNAL_FLASH BIT(6)
#define IT83XX_SMFI_ECINDDR     ECREG(IT83XX_SMFI_BASE+0x3F)
#define IT83XX_SMFI_SCAR2L      ECREG(IT83XX_SMFI_BASE+0x46)
#define IT83XX_SMFI_SCAR2M      ECREG(IT83XX_SMFI_BASE+0x47)
#define IT83XX_SMFI_SCAR2H      ECREG(IT83XX_SMFI_BASE+0x48)
#define IT83XX_SMFI_FLHCTRL3R   ECREG(IT83XX_SMFI_BASE+0x63)
#define IT83XX_SMFI_STCDMACR    ECREG(IT83XX_SMFI_BASE+0x80)
#define IT83XX_SMFI_FLHCTRL6R   ECREG(IT83XX_SMFI_BASE+0xA2)
