...
#define IT83XX_GPIO_GPCRA(ch)      ECREG(IT83XX_GPIO_BASE+0x10+ch)


/* --- Pulse Width Modulation (PWM) --- */
#define IT83XX_PWM_BASE   0x00F01800

#define IT83XX_PWM_C0CPRS       ECREG(IT83XX_PWM_BASE+0x00)
#define IT83XX_PWM_CTR          ECREG(IT83XX_PWM_BASE+0x01)
#define IT83XX_PWM_DCR(baseaddr)      ECREG(0x02+baseaddr)
#define IT83XX_PWM_PWMPOL       ECREG(IT83XX_PWM_BASE+0x0A)
#define IT83XX_PWM_PCFSR        ECREG(IT83XX_PWM_BASE+0x0B)
#define IT83XX_PWM_PCSSGL       ECREG(IT83XX_PWM_BASE+0x0C)
#define IT83XX_PWM_PCSSGH       ECREG(IT83XX_PWM_BASE+0x0D)
#define IT83XX_PWM_CR256PCSSG   ECREG(IT83XX_PWM_BASE+0x0E)
#define IT83XX_PWM_PCSGR        ECREG(IT83XX_PWM_BASE+0x0F)
#define IT83XX_PWM_CTR1M        ECREG(IT83XX_PWM_BASE+0x10)
#define IT83XX_PWM_F1TLRR       ECREG(IT83XX_PWM_BASE+0x1E)
#define IT83XX_PWM_F1TMRR       ECREG(IT83XX_PWM_BASE+0x1F)
#define IT83XX_PWM_F2TLRR       ECREG(IT83XX_PWM_BASE+0x20)
#define IT83XX_PWM_F2TMRR       ECREG(IT83XX_PWM_BASE+0x21)
#define IT83XX_PWM_ZINTSCR      ECREG(IT83XX_PWM_BASE+0x22)
#define IT83XX_PWM_ZTIER        ECREG(IT83XX_PWM_BASE+0x23)
#define IT83XX_PWM_TSWCTLR      ECREG(IT83XX_PWM_BASE+0x24)
#define IT83XX_PWM_C4CPRS       ECREG(IT83XX_PWM_BASE+0x27)
#define IT83XX_PWM_C4MCPRS      ECREG(IT83XX_PWM_BASE+0x28)
#define IT83XX_PWM_C6CPRS       ECREG(IT83XX_PWM_BASE+0x2B)
#define IT83XX_PWM_C6MCPRS      ECREG(IT83XX_PWM_BASE+0x2C)
#define IT83XX_PWM_C7CPRS       ECREG(IT83XX_PWM_BASE+0x2D)
#define IT83XX_PWM_C7MCPRS      ECREG(IT83XX_PWM_BASE+0x2E)
#define IT83XX_PWM_CLK6MSEL     ECREG(IT83XX_PWM_BASE+0x40)
#define IT83XX_PWM_CTR1         ECREG(IT83XX_PWM_BASE+0x41)
#define IT83XX_PWM_CTR2         ECREG(IT83XX_PWM_BASE+0x42)
#define IT83XX_PWM_CTR3         ECREG(IT83XX_PWM_BASE+0x43)
#define IT83XX_PWM_PWM5TOCTRL   ECREG(IT83XX_PWM_BASE+0x44)
#define IT83XX_PWM_CFLRR        ECREG(IT83XX_PWM_BASE+0x45)
#define IT83XX_PWM_CFMRR        ECREG(IT83XX_PWM_BASE+0x46)
#define IT83XX_PWM_CFINTCTRL    ECREG(IT83XX_PWM_BASE+0x47)
#define IT83XX_PWM_TSWCTRL      ECREG(IT83XX_PWM_BASE+0x48)
#define IT83XX_PWM_PWMODENR     ECREG(IT83XX_PWM_BASE+0x49)
